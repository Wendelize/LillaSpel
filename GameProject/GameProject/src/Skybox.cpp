...
Skybox::Skybox()
{
	m_verticesSkybox = nullptr;
	m_indicesSkybox = nullptr;
	CreateSkybox();
	InitSkybox();
}
...
void Skybox::InitSkybox()
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(skyboxData), nullptr);
}
...
void Skybox::DrawSkybox(Shader* shaderProgram)
{
	...
	glDrawElements(GL_TRIANGLES, m_nrOfISkybox, GL_UNSIGNED_INT, static_cast<void*>(nullptr));
	glBindVertexArray(0);
