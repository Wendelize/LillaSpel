...
Window::Window(int width, int height)
{
	...
	m_fonts.push_back(io.Fonts->AddFontFromFileTTF("src/IMGUI/Fonts/muscle_cre/muscle_cre.ttf", 20.0f));
	m_fonts.push_back(io.Fonts->AddFontFromFileTTF("src/IMGUI/Fonts/muscle_cre/muscle_cre.ttf", 60.0f));
